...
<html lang="en">
  ...
  <form  action="buscar_reservas.php" method="get" class="form-inline position-relative my-2 d-inline-block">
      
      <input class="form-control mr-sm-2 " type="search" placeholder="Buscar reserva" aria-label="Buscar habitacion" id="busqueda" name="busqueda">
