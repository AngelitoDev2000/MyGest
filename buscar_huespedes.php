...
if(empty($busqueda))
{
 ...
 <form action="buscar_huespedes.php" method="get" class="form-inline position-relative my-2 d-inline-block">
      <input class="form-control mr-sm-2 " type="search" placeholder="Buscar clientes" aria-label="Buscar clientes" id="busqueda" name="busqueda" value="<?php echo $busqueda; ?>">
...
$sql2="SELECT nombre_usuario, numero_habitacion, lugar FROM reservas  WHERE (numero_habitacion like '%$busqueda%' OR 
