...
<link rel="stylesheet" href="assets/css/style.css">
  ...
  <form action="buscar_habitaciones.php" method="get" class="form-inline position-relative my-2 d-inline-block">
      <input class="form-control mr-sm-2 " type="search" placeholder="Buscar habitacion" aria-label="Buscar habitacion" id="busqueda" name="busqueda">
...
<td> <a class="btn btn-info" href="edit_habitacion.php?habitacion=<?php echo $mostrar['id_habitacion']?>">Editar</a> </td>
