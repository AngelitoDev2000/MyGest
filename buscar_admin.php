...
if(empty($busqueda))
{
 ...
 <form action="buscar_admin.php" method="get" class="form-inline position-relative my-2 d-inline-block">
      <input class="form-control mr-sm-2 " type="search" placeholder="Buscar cliente" aria-label="Buscar cliente" id="busqueda" name="busqueda" value="<?php echo $busqueda; ?>">
...
$sql="SELECT * FROM usuarios WHERE (id_usuario like '%$busqueda%' OR 
